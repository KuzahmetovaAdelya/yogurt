...
export default function CatalogSection({setPage, scrollUp}) {
    return (
        <>
            <div className="w-350 mx-auto mt-16 lg:w-tablet xl:w-notepad xl:mt-36 2xl:w-desktop" id="catalog">
                <div className="flex items-center justify-between mb-6 xl:mb-10">
                    ...
                    <button className="flex items-center lg:gap-2.5 cursor-pointer group" onClick={() => {setPage('catalog'); scrollUp()}}>
                ...
                <div className="grid grid-cols-1 gap-5 lg:grid-cols-2 xl:gap-10">
                    <BigCard setPage={setPage} scrollUp={scrollUp} />
                    <BigCard setPage={setPage} scrollUp={scrollUp} />
                </div>
                ...
                <div className="grid grid-cols-2 gap-5 lg:grid-cols-3 lg:gap-10 xl:grid-cols-4">
                    ...
                    <SmallCard setPage={setPage} scrollUp={scrollUp} />
                    <SmallCard setPage={setPage} scrollUp={scrollUp} />
                    <div className="xl:hidden"><SmallCard setPage={setPage} scrollUp={scrollUp} /></div>
                    <div className="xl:hidden"><SmallCard setPage={setPage} scrollUp={scrollUp} /></div>
                    </div>
