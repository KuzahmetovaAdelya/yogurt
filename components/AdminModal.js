export default function Modal({closeModal, id, header}) {
    // let pageName;
    ...
    return (
        <div class="modal block fixed z-50 top-0 left-0 w-screen h-screen bg-rgba-black">
            <div class="modal-content bg-admin-black w-830 h-606 rounded-basket mx-auto mt-44 p-5">
                ...
                <div>
                    <form>
                        ...
                        <div className="w-500 flex items-start justify-between mt-2.5">
                            ...
                            <label draggable="true" htmlFor="file" className="cursor-pointer text-big-para-2xl flex items-center justify-center w-148 h-114 bg-admin-gray rounded-basket">
                            ...
                            <div className="grid grid-cols-2 w-300 gap-2.5">
                                    <div className="flex items-center gap-9">
                                        ...
                                        <button className="group hover:bg-admin-black border border-light-gray bg-light-gray w-9 h-9 flex items-center justify-center rounded-basket">
                        ...
                        <div className="mt-5 grid grid-rows-4 grid-cols-2 grid-flow-col gap-x-5">
                            ...
                            <div className="flex flex-col gap-2.5">
                                ...
                                <textarea type="text" name="description" id="description" className="resize-none font-serif focus-visible:outline-1 w-full bg-admin-gray font-sm pl-5 py-1.5 pr-2.5 rounded-basket" placeholder="Текст" />
                            </div>
                            ...
                            <button className="self-end justify-self-end bg-blue h-9 w-52 rounded-basket hover:bg-white hover:text-blue transition">Сохранить</button>
                        </div>
                    </form>
                </div>
            </div>
