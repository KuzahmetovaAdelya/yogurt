        ...
        <>
            <div className="w-350 mx-auto mt-20 lg:w-tablet lg:mt-40 lg:mb-20 xl:w-notepad xl:mt-64 2xl:w-desktop">
                <div className="lg:flex lg:justify-between lg:items-center lg:mb-10 xl:mb-5">
                    ...
                    <h2 className="uppercase text-white text-2xl font-semibold tracking-tighter mb-5 lg:hidden">Коллаборации</h2>
                </div>
                ...
                <div className="lg:hidden">
                    <div>
                        <img src="/photo.png" className="w-350 mb-3"></img>
                        <div>
                    ...
                    <p className="text-white font-medium text-p tracking-tighter text-center mt-75">Музыкант / DJ / Biicla</p>
                </div>
