        ...
        <>
            <div className="fixed top-0 bg-admin-black w-screen h-24 border-b border-b-gray p-7 z-10">
                <div className="flex items-center justify-between h-full">
                    <a href="/" className="uppercase text-2xl text-light-gray font-semibold cursor-pointer hover:text-gray transition">yegourt</a>
            ...
            <div className="fixed top-0 bg-admin-black h-screen w-52 border-r border-r-gray px-7">
                <div className="mt-64 flex flex-col gap-5">
                    <a className="cursor-pointer flex items-center justify-between p-1 hover:bg-white rounded-md group transition" href="/admin-catalog">
                    ...
                    <a className="cursor-pointer flex items-center justify-between p-1 hover:bg-white rounded-md group transition" href="/admin-concepts">
                        <div className="flex items-center gap-4">
                    ...
                    <a className="cursor-pointer flex items-center justify-between p-1 hover:bg-white rounded-md group transition" href="/admin-collabs">
                        <div className="flex items-center gap-4">
